...
path = roslib.packages.get_pkg_dir('crazyflie_ros') + "/lib/cfclient/ui/dialogs/inputconfigdialogue.ui"
inputconfig_widget_class, connect_widget_base_class = uic.loadUiType(path)
