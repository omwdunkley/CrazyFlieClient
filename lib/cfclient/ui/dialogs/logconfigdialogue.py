...
path = roslib.packages.get_pkg_dir('crazyflie_ros') + "/lib/cfclient/ui/dialogs/logconfigdialogue.ui"
logconfig_widget_class, connect_widget_base_class = uic.loadUiType(path)
