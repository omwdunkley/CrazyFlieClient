...
#debugdriver_tab_class = uic.loadUiType(sys.path[0] + "/cfclient/ui/toolboxes/debugDriverToolbox.ui")[0]

import roslib; roslib.load_manifest('crazyflie_ros')
path = roslib.packages.get_pkg_dir('crazyflie_ros') + "/lib/cfclient/ui/toolboxes/debugDriverToolbox.ui"
debugdriver_tab_class = uic.loadUiType(path)[0]
