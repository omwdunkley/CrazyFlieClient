...
# from crazyflie_ros.msg import imu as imu_msg
# from crazyflie_ros.msg import imu_target as imu_target_msg
# from crazyflie_ros.msg import motor as motor_msg
...
#path = sys.path[0] + "/cfclient/ui/tabs/flightTab.ui"
#print "--->", path
#flight_tab_class = uic.loadUiType(path)[0]


#todo
path = roslib.packages.get_pkg_dir('crazyflie_ros') + "/lib/cfclient/ui/tabs/flightTab.ui"
flight_tab_class = uic.loadUiType(path)[0]
