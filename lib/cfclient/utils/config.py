...
class Config():
    ...
    def __init__(self):
        ...
        self._dist_config = roslib.packages.get_pkg_dir('crazyflie_ros') + "/lib/cfclient/configs/config.json"
        self._config = roslib.packages.get_pkg_dir('crazyflie_ros') + "/lib/configs/config.json"
